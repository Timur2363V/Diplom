	...
	{	
       ...
       static public void InitJavaActivity()
       {
		...
		private void OnDestroy()
		{
            ...
            if (!bVR9)
            {
                if (DpnCameraRig._instance != null)
                {
                    if (DpnCameraRig._instance._left_eye)
                        DpnCameraRig._instance._left_eye.targetTexture = null;

                    if (DpnCameraRig._instance._right_eye)
                        DpnCameraRig._instance._right_eye.targetTexture = null;

                    if (DpnCameraRig._instance._center_eye)
                        DpnCameraRig._instance._center_eye.targetTexture = null;
                }
