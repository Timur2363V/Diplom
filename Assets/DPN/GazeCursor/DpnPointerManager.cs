...
namespace dpn
{
    public class DpnPointerManager : MonoBehaviour
    {
        ...
        {
            float z = (DpnCameraRig._instance._center_eye.nearClipPlane + DpnCameraRig._instance._center_eye.farClipPlane) * 0.5f;
        ...
        {
            if (!DpnManager.DPVRPointer || DpnCameraRig._instance == null)
                return;

            GameObject castObject = pointerEvent.pointerCurrentRaycast.gameObject;

            Ray castRay = DpnCameraRig._instance.CurrentPeripheral.GetRay();
        ...
        void LateUpdate()
        {
            ...
            Ray r = DpnCameraRig._instance.CurrentPeripheral.GetRay();
        ...
        {
            yield return new WaitForEndOfFrame();
            ray.SetVisible(DpnCameraRig._instance.CurrentPeripheral.PeripheralType != DPVRPeripheral.None);
        }
